...
const weatherIcons = {
    ...
    '陰時多雲': '/assets/img/weatherIcon/06.svg',
    '陰天': '/assets/img/weatherIcon/07.svg',
    '多雲陣雨': '/assets/img/weatherIcon/08.svg',
    '多雲短暫雨': '/assets/img/weatherIcon/08.svg',
    '多雲短暫陣雨': '/assets/img/weatherIcon/08.svg',
    '短暫陣雨': '/assets/img/weatherIcon/08.svg',
    '多雲時晴短暫陣雨': '/assets/img/weatherIcon/08.svg',
    '多雲時晴短暫雨': '/assets/img/weatherIcon/08.svg',
    '晴時多雲短暫陣雨': '/assets/img/weatherIcon/08.svg',
    '晴短暫陣雨': '/assets/img/weatherIcon/08.svg',
    '短暫雨': '/assets/img/weatherIcon/08.svg',
    '多雲時陰短暫雨': '/assets/img/weatherIcon/09.svg',
    '多雲時陰短暫陣雨': '/assets/img/weatherIcon/09.svg',
    '雨天': '/assets/img/weatherIcon/10.svg',
    '晴午後陰短暫雨': '/assets/img/weatherIcon/10.svg',
    '晴午後陰短暫陣雨': '/assets/img/weatherIcon/10.svg',
    '陰短暫雨': '/assets/img/weatherIcon/10.svg',
    '陰短暫陣雨': '/assets/img/weatherIcon/10.svg',
    '陰午後短暫陣雨': '/assets/img/weatherIcon/10.svg',
